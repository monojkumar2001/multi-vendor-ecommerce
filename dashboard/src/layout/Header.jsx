...
const Header = ({ showSidebar, setShowSidebar }) => {
  return (
    <div className="fixed top-0 left-0 w-full md:py-5 px-2 lg:px-7 z-40">
          ...
          <div className="flex justify-center items-center">
            <div className="flex justify-center items-center gap-3">
              <div className="flex justify-center items-center flex-col text-end">
                <h2 className=" text-sm font-bold">monoj kumar</h2>
                <span className="text-[14px] font-normal w-full">Admin</span>
              </div>
              <img
                className="w-[45px] h-[45px] rounded overflow-hidden"
